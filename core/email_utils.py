            ...
            <tr>
                <td align="center">
                    <table width="480" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:12px; overflow:hidden; box-shadow: 0 2px 12px rgba(0,0,0,0.06);">
                        ...
                        <!-- Logo bar -->
                        <tr>
                            <td style="background-color:#1a1a2e; padding: 28px 30px; text-align:center;">
                                <img src="https://rewright.app/static/core/logo-email.png" alt="Rewright" width="80" height="80" style="display:block; margin: 0 auto 12px auto; border:0;" />
                                <span style="font-size:28px; font-weight:700; color:#e8a24e; letter-spacing:0.5px;">
                                    Rewright
                                </span>
                            </td>
                        </tr>
