                    ...
                    <table width="480" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:12px; overflow:hidden; box-shadow: 0 2px 12px rgba(0,0,0,0.06);">
                        ...
                        <tr>
                            <td style="background-color:#1a1a2e; padding: 24px 30px; text-align:center;">
                                <img src="https://rewright.app/static/core/logo-email.png" alt="Rewright" width="44" height="44" style="display:inline-block; vertical-align:middle; margin-right:10px; border:0;" />
                                <span style="font-size:26px; font-weight:700; color:#e8a24e; letter-spacing:0.5px; vertical-align:middle;">
                                    Rewright
                                </span>
                            </td>
                        </tr>
